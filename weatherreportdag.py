...
#default parameters for airflow dag
default_args= {
    "owner":"weatherAPI",
    'start_date': datetime(2024, 1, 2, 10, 30)
}
...
#weather Apikey 
openweather_api = 'openwaether-apikey'
...
with DAG(dag_id ='weatherreportdag',default_args=default_args,schedule_interval='@daily',catchup=False) as dag:
    streaming_task = PythonOperator(task_id = 'weather_api_per_minute',python_callable=get_minute_weather_report)
